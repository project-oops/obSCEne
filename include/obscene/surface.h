...
#define OBS_SURFACE_PAD(X) \
    ...
    X(scePadSetVibrationTriggerEffectWeakWhileEmbeddedMicInUse)
...
#define OBS_SURFACE_SYNC_ON_ADDRESS2(X) \
    ...
    X(sceKernelSyncOnAddressWait16) \
    X(sceKernelSyncOnAddressWait32) \
    X(sceKernelSyncOnAddressWait64)
