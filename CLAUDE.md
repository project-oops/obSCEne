...
- `reports/archive/gpu-golden.txt` - a blessed snapshot of what the build VM's llvmpipe computes for
  every kernel. It records the kernel-output references the oracle checks.
